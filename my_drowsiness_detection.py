...
mixer.init()
alarm_sound = mixer.Sound(r'D:\Downloads\driver-drowsiness-detection-Project\alarm.wav')

# this xml files are used to detect face , left eye , and right eye of a person.
face_detection = cv2.CascadeClassifier(r'D:\Downloads\driver-drowsiness-detection-Project\haar cascade files\haarcascade_frontalface_alt.xml')
left_eye_detection = cv2.CascadeClassifier(r'D:\Downloads\driver-drowsiness-detection-Project\haar cascade files\haarcascade_lefteye_2splits.xml')
right_eye_detection = cv2.CascadeClassifier(r'D:\Downloads\driver-drowsiness-detection-Project\haar cascade files\haarcascade_righteye_2splits.xml')

labels =['Close','Open']

# load the model, that we have created
model = load_model(r'D:\Downloads\driver-drowsiness-detection-Project\models\custmodel.h5')
